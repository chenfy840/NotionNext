const CONFIG = {
  ...
  NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://haojun0129.link' },
  ],

  // 英雄区(首页顶部大卡)
  HERO_TITLE_1: '分享编程',
  HERO_TITLE_2: '与思维认知',
  HERO_TITLE_3: '数码科技爱好者',
  HERO_TITLE_4: '新版上线',
  HERO_TITLE_5: '分享与热心帮助',
  HERO_TITLE_LINK: 'https://haojun0129.link',
  ...
  INFO_CARD_URL: 'https://github.com/chenfy840/NotionNext', // 个人资料底部按钮链接
